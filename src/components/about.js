...
export default function About() {
    ...
    return (
        <div ref={container} className='about__container'>
            ...
            <p ref={info} className='about__info'>My name is Phoenix. I merge my interests in game and web development, currently in London. Feel free to <a href={'//www.linkedin.com/in/phoenixmee/'} target='_blank' rel='noopener noreferrer'>get in touch</a>. In the meantime, enjoy some photos of my time living in Japan.</p>
        </div>
    );
}