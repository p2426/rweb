...
export default function OrphanedElements({type, title}) {
    ...
    return (
        ...
        <div className='body'>
            ...
            <pre><code>
{isMobile ? `Code available on desktop version` : `const AnimatedPath = () => {
    const svg = useRef();
